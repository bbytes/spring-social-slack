...
/**
 * {@link NamespaceHandler} for Spring Social Slack
 * 
 * @author Thanneer
 */
public class SlackNamespaceHandler extends AbstractProviderConfigNamespaceHandler {

	@Override
	protected AbstractProviderConfigBeanDefinitionParser getProviderConfigBeanDefinitionParser() {
		return new SlackConfigBeanDefinitionParser();
	}
